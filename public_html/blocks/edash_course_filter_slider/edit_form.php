...
class block_edash_course_filter_slider_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Subtitle
        $mform->addElement('text', 'config_subtitle', get_string('config_subtitle', 'theme_edash') .' (not for Style 4)');
        ...
        $mform->addElement('text', 'config_btn_img', 'Button Icon Image URL(for Style 4)');
