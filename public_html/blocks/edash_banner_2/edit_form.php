...
class block_edash_banner_2_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_search_placeholder', get_string('config_search_placeholder', 'block_edash_banner_2'));
        ...
        // Search Button Text
        $mform->addElement('text', 'config_search_btn', get_string('config_search_btn', 'block_edash_banner_2'));
        $mform->setDefault('config_search_btn', 'Search');
        $mform->setType('config_search_btn', PARAM_RAW);

        $select = $mform->addElement('select', 'config_button_icon', get_string('config_button_icon', 'block_edash_banner_2'), $edashFontList, array('class'=>'edash_icon_class'));
        ...
        $mform->addElement('select', 'config_funfactsnumber', get_string('config_funfacts_items', 'block_edash_banner_2'), $funfactsrange);
        ...
        for($i = 1; $i <= $funfactsnumber; $i++) {
            $mform->addElement('header', 'config_edash_item' . $i , get_string('config_funfacts_items', 'block_edash_banner_2') . $i);
