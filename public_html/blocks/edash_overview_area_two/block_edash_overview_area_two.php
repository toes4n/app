...
class block_edash_overview_area_two extends block_base {
    public function init() {
        $this->title = get_string('pluginname', 'block_edash_overview_area_two');
    }
    ...
    public function specialization()
    {
        ...
        if (empty($this->config)) {
            ...
            $this->config->title = 'Industrial business black sheep among white ones';
            $this->config->body = 'Explore all of our courses and pick your suitable ones to enroll and start learning with us!';
            $this->config->quote = 'It is expected that the vendor will already be providing their services for the county and that the vendor’s system is being updated with results, prior to performing this process';
    ...
    public function get_content() {
        ...
        <div class="vc-overview-area pb-100" style="background-image:url('.edash_block_image_process($this->content->shape_img).');">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="vc-overview-content">
