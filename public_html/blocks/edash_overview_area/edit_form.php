...
class block_edash_overview_area_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->setDefault('config_title', 'Stress-Free recipes to cook for and with your family');
        ...
        // Button Text
        $mform->addElement('text', 'config_btn', get_string('config_btn', 'block_edash_overview_area'));
        $mform->setDefault('config_btn', 'Download Free Now');
        $mform->setType('config_btn', PARAM_RAW);

        // Button Link
        $mform->addElement('text', 'config_btn_link', get_string('config_btn_link', 'block_edash_overview_area'));
