...
class __Mustache_5b1ca327d222265a573c24764eabbd83 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= ' user-notif edash-settings-nav edash-settings-nav-notif" 
';
        $buffer .= $indent . '    ';
...
';
        $buffer .= $indent . '            class="btn nav-link dropdown-toggle popover-region-toggle" 
';
...
';
        ...
        if (is_callable($blockFunction)) {
            ...
            $buffer .= $this->section4ee3277bda6c684ca9856cf2dd4e66e3($context, $indent, $value);
        }
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
    ...
    private function section4ee3277bda6c684ca9856cf2dd4e66e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
