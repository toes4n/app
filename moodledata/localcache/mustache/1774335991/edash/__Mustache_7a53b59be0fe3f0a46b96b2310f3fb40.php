...
class __Mustache_7a53b59be0fe3f0a46b96b2310f3fb40 extends Mustache_Template
{
...
';
        $value = $context->find('inlinelabel');
        $buffer .= $this->section0385dc8f32d456736701b2dffd9d615e($context, $indent, $value);
        $value = $context->find('inlinelabel');
        if (empty($value)) {
...
';
    ...
    private function section0385dc8f32d456736701b2dffd9d615e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
