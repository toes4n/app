...
/**
 * Strings for component 'label', language 'ar', version '4.0'.
 *
 * @package     label
 * @category    string
...
$string['configdndmedia'] = 'يعرض هذا الخيار إنشاء مُلصقات عند سحب وإفلات ملفات الوسائط في صفحة المساق';
...
$string['dnduploadlabeltext'] = 'إضافة ملصق إلى صفحة المساق';
