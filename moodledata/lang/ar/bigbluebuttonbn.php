...
/**
 * Strings for component 'bigbluebuttonbn', language 'ar', version '4.0'.
 *
...
$string['config_lockonjoin_default'] = 'التأمين عند الانضمام مُمَكَّن إفتراضيًا';
$string['config_lockonjoin_default_description'] = 'عند تمكينه، سيتم تطبيق الإعدادات المؤمنة عند التهيئة على المستخدم عند انضمامه. تأمين التهيئة ينبغي تمكينه ليكون هذا مطبقًا.';
$string['config_lockonjoin_editable'] = 'التأمين عند الانضمام يمكن تحريره';
$string['config_lockonjoin_editable_description'] = 'التأمين عند الانضمام إفتراضيًا يمكن تحريره عند إضافة المثيل أو تحديثه.';
...
$string['enablingbigbluebuttondpainfo'] = 'من أجل تلبية مستلزمات حماية بياناتك، تأكد من قراءة <a href="{$a}" target="_blank">اتفاقية معالجة البيانات</a> والموافقة عليها والتي تقدمها شركة Blindside Networks Inc.<br/>
...
$string['mod_form_field_lockonjoin'] = 'تأمين الإعدادات عند الانضمام';
