...
/**
 * Strings for component 'admin', language 'ar', version '4.0'.
 *
 * @package     admin
 * @category    string
...
$string['configsupportpage'] = 'سيتم تقديم رابط لهذه الصفحة للمستخدمين من أجل الاتصال بدعم الموقع. إذا تم ترك الحقل فارغاً، فسيتم تقديم رابط لنموذج الدعم الفني بدلاً منه.';
...
$string['xmlrpcmnetauthenticationenabled'] = 'لقد تم الكشف عن تمكين مصادقة شبكة مودل في موقعك. هذه الميزة تعتمد على امتداد PHP XML-RPC وهذا الأخير لم يعد مدعومًا من قبل PHP.';
