...
/**
 * Strings for component 'tool_moodlenet', language 'ar', version '4.0'.
 *
...
$string['autoenablenotification'] = '<p>في الإصدار 4.0 من مودل فصاعدًا، سيكون تكامل <a href="https://moodle.net/">شبكة مودل</a> مُمَكَّنًا بشكل افتراضي في المزايا المتقدمة. سيتمكن المستخدمون ذووي إمكانية إنشاء النشاطات وإدارتها من استعراض شبكة مودل عبر منتقي النشاطات واستيراد موارد الشبكة إلى مساقاتهم.</p><p>عند الرغبة، يمكن تحديد عينة بديلة من شبكة مودل في <a href="{$a->settingslink}">إعدادات شبكة مودل</a>.</p>';
