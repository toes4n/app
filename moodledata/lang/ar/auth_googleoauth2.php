...
/**
 * Strings for component 'auth_googleoauth2', language 'ar', version '4.0'.
 *
...
<br/><strong>تنبيه: قام فيسبوك مؤخراً بتغيير واجهة برمجة التطبيق. لم يعد شغالاً بالنسبة إلى مفاتيح واجهة برمجة التطبيق المولدة حديثاً. على سبيل المثال، نحن نعلم أنه متعطل منذ واجهة برمجة التطبيق لفيسبوك 2.8 وإنه شغال حتى للإصدار 2.2 منه. لم نقم باختباره مع الإصدارات 2.3، 2.4، 2.5، 2.6 و 2.7. باختصار، إذا لم يكن لديك مسبقاً مفتاح قديم لواجهة برمجة التطبيق من فيسبوك، فبالتأكيد لن يكون بالإمكان تسجيل الدخول عبر فيسبوك. لطفاً، أنظر في بدائل الإضافة أو انتظر التحديث الرئيسي القادم للإضافة (غير مخطط له بعد).</strong>';
...
$string['stattitle'] = 'إحصائيات تسجيل الدخول لهذه الإضافة';
$string['stattitlecaption'] = 'إحصائيات الأيام {$a->periodindays} الأخيرة.';
$string['supportmaintenance'] = 'لدعم صيانة هذه الإضافة، سجل دخولك إلى<a target="_blank" href="https://moodle.org/plugins/view/auth_googleoauth2">صفحة Moodle.org للإضافة</a> وانقر على \'إضافة إلى مفضلاتي\'. شكراً!';
